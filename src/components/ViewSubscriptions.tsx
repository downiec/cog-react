...
export default function ViewSubscriptions(props: ISubscribeProps): JSX.Element {
  ...
  return (
    <Layout>
      <Divider>
        <Title level={2}>Current Subscriptions</Title>
      </Divider>
      <Row>
        <Divider orientation="left">
          <Title level={3}>Delete to experiment(s)</Title>
        </Divider>
      </Row>
      ...
      <Row>
        <Divider orientation="left">
          <Title level={3}>Delete to variables(s)</Title>
        </Divider>
      </Row>
      {stateSelector(
        "Filter By Frequency:",
      ...
      <Row>
        <Divider orientation="left">
          <Title level={3}>Delete to model(s)</Title>
        </Divider>
      </Row>
